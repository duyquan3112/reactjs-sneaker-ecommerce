...
import NewArrivalBanner from "../Banners/NewArrivalBanner.jsx";
  ...
  return (
    <div className="mt-14 mb-14 w-screen bg-topbar-black px-4 md:px-24 py-12 overflow-hidden">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 lg:gap-12">
        <div className="flex flex-col gap-2 flex-shrink-0 lg:max-w-md">
        ...
        <div className="w-full h-[12rem] lg:h-[24rem] max-w-full overflow-hidden">
          <NewArrivalBanner />
        </div>
      </div>
